...
CREATE TABLE IF NOT EXISTS moderation_role_settings
(
...
ALTER TABLE moderation_role_settings ADD COLUMN sync_subscriber_role_id TEXT;
ALTER TABLE moderation_role_settings ADD COLUMN sync_vip_role_id TEXT;
ALTER TABLE moderation_role_settings ADD COLUMN sync_moderator_role_id TEXT;
ALTER TABLE moderation_role_settings ADD COLUMN sync_broadcaster_role_id TEXT;
