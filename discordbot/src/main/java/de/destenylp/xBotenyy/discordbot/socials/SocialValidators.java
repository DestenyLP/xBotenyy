...
public final class SocialValidators {
    ...
    private static final Pattern TIKTOK_USERNAME = Pattern.compile("^[a-zA-Z0-9_.]{2,24}$");
    ...
    public static boolean isValidTiktokUsername(String value) {
        return value != null && TIKTOK_USERNAME.matcher(value).matches();
    }
}
