...
public class SocialManager extends AbstractSqlManager implements SocialRepository {
    ...
    private SocialAccount mapAccount(ResultSet resultSet) throws SQLException {
        SocialAccount account = SocialAccount.builder()
                ...
                .tiktokUsername(resultSet.getString("tiktok_username"))
                .tiktokMessage(resultSet.getString("tt_content"))
                .build();
        ...
        account.setLastTiktokVideoId(resultSet.getString("last_tiktok_video_id"));
        ...
        tt.setTitleUrl(resultSet.getString("tt_title_url"));
        tt.setAuthor(resultSet.getString("tt_author"));
        tt.setColor(resultSet.getString("tt_color"));
