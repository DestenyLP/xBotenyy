...
public final class BotMetrics {
    ...
    private static final String TIKTOK_VIDEOS_ANNOUNCED = "discord.tiktok_videos_announced";
    ...
    public static void incrementTiktokVideosAnnounced() {
        Metrics.increment(TIKTOK_VIDEOS_ANNOUNCED);
    }
    ...
    public static long getTiktokVideosAnnounced() {
        return Metrics.get(TIKTOK_VIDEOS_ANNOUNCED);
    }
